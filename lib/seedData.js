...
export const tabs = [
  ...
  { key: "historico", label: "Histórico", adminOnly: true }
];

export const clients = [];

export const team = [
  { id: "t1", name: "Bruna", area: "Gestão", email: "bruna@verve.com.br", role: "admin" },
  { id: "t2", name: "Mayara", area: "Social media", email: "mayara@verve.com.br", role: "member" },
  { id: "t3", name: "Luiza", area: "Edição de vídeo", email: "luiza@verve.com.br", role: "member" },
  { id: "t4", name: "Naara", area: "Design", email: "naara@verve.com.br", role: "member" },
  { id: "t5", name: "Thalles", area: "Administração", email: "thalles@verve.com.br", role: "admin" }
];
